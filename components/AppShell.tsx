...
const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Install Planning', href: '/planting', icon: 'sprout' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'CropX Order', href: '/cropx', icon: 'cpu' },
    ...
    <>
      ...
      <div className="mobile-header">
        ...
        <div className="mobile-header-right">
          <button onClick={() => window.location.reload()} aria-label="Refresh" style={{ background: 'none', border: 'none', color: 'var(--text-secondary)', cursor: 'pointer', padding: '4px' }}>
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" width="20" height="20">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
            </svg>
          </button>
          <button className="no-print" onClick={() => window.print()} aria-label="Print" style={{ background: 'none', border: 'none', color: 'var(--text-secondary)', cursor: 'pointer', padding: '4px' }}>
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" width="20" height="20">
